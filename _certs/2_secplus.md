...
<div class="row justify-content-sm-center">
    <div class="col-sm-4 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="/assets/img/secplus/logo.png" title="Security+ Logo" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<ul>
    <li>Official page: <a href="https://www.comptia.org/certifications/security">https://www.comptia.org/certifications/security</a></li>
...
<p>Accredited by ANSI to show compliance with the ISO/IEC 17024 Standard.</p>
