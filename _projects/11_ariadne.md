...
<div class="row justify-content-sm-center">
    <div class="col-sm-8 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="/assets/img/ariadne/steps.png" title="Investigation Steps" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
{% endcapture %}
{% include terminal.html language='python' title='engagements.py' content=routes %}
...
{% endraw %}
{% endcapture %}
{% include terminal.html language='javascript' title='EngagementWorkspace.jsx' content=engagepage %}
