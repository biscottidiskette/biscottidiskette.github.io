...
<div class="row justify-content-sm-center">
    <div class="col-sm-4 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="/assets/img/ariadne/logo.png" title="Ariadne" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<br />
## My Role
I followed the same model as my previous projects. I architected the application end-to-end and handled all engineering decisions. That meant designing the context window management strategy, deciding what gets persisted and how it feeds back into prompts, and mapping the ingestion pipeline across artifact formats. Claude AI generated the code from the architecture I defined. I drove generation through precise prompt engineering, one feature at a time, and reviewed everything as a repository maintainer before it landed.

<br />
## Current Status
MVP: In Progress. The engine runs. The analysis takes shape. The real test is whether it finds the thread worth pulling.
...
<div class="row justify-content-sm-center">
    <div class="col-sm-8 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="/assets/img/ariadne/landingpage.png" title="Landing Page" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div class="row justify-content-sm-center">
    <div class="col-sm-8 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="/assets/img/ariadne/investigation.png" title="Individual Investigation" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div class="row justify-content-sm-center">
    <div class="col-sm-8 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="/assets/img/ariadne/pasteartifacts.png" title="Paste Artifacts" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div class="row justify-content-sm-center">
    <div class="col-sm-8 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="/assets/img/ariadne/notetaking.png" title="Notetaking" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div class="row justify-content-sm-center">
    <div class="col-sm-8 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="/assets/img/ariadne/ioc.png" title="IoC Tracking" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div class="row justify-content-sm-center">
    <div class="col-sm-8 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="/assets/img/ariadne/repeat.png" title="Avoid Repeats" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
def init_db() -> None:
    ...
    try:
        ...
        <snip>
{% endcapture %}
{% include terminal.html language='python' title='db.py' content=conn %}
...
{% endcapture %}
{% include terminal.html language='python' title='database_service.py' content=dbservice %}
...
{% endcapture %}
{% include terminal.html language='python' title='groq.py' content=groq %}
...
def parse_chainsaw(raw_content: str) -> dict:
    ...
    <snip>
{% endcapture %}
{% include terminal.html language='python' title='chainsaw_parser.py' content=parsers %}
...
{% endcapture %}
{% include terminal.html language='python' title='playbook.py' content=routes %}
...
<div class="row justify-content-sm-center">
    <div class="col-sm-4 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="/assets/img/ariadne/endlogo.png" title="Ariadne" class="img-fluid rounded z-depth-1" %}
    </div>
</div>