...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
        ...
        },{id: "post-breaking-web-application-busting-makes-me-feel-good",
      ...
      handler: () => {
          ...
          window.location.href = "/blog/2026/cwes/";
      ...
      handler: () => {
          ...
          title: 'Fd',
          description: "Pass the correct Input/Output value.",
          section: "Boxes",handler: () => {
              window.location.href = "/boxes/112_fd/";
            },},{id: "boxes-snapped",
          title: 'Snapped',
          description: "Triggered and pilfered Nginx UI backups.",
          section: "Boxes",handler: () => {
              window.location.href = "/boxes/113_snapped/";
            },},{id: "boxes-htb-blue",
          title: 'HTB Blue',
