...
tags: [certification,cissp,study,career]
...
<div class="row justify-content-sm-center">
    <div class="col-sm-4 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="/assets/img/cisspdissonance/logo.png" title="Din of Dissonance" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
# The Din of Dissonance: The Struggle With My CISSP Preparation

<br />
## The Reasoning
The CISSP is aguably the most recognizable certification in cybersecurity industry.   

<br />
## The Situation
The CISSP is knowledge dense study material with 
