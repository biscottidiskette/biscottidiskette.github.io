...
{% endcapture %}
{% include terminal.html language='bash' title='bash' content=downloadjar %}

<br />
Run jd-gui to decompile the BlockyCore.jar file.

{% capture jdguireverse %}
┌──(kali㉿kali)-[~/Documents/htb/blocky]
└─$ jd-gui BlockyCore.jar                                        
Picked up _JAVA_OPTIONS: -Dawt.useSystemAAFontSettings=on -Dswing.aatext=true
{% endcapture %}
{% include terminal.html language='bash' title='bash' content=jdguireverse %}
...
{% endcapture %}
{% include terminal.html language='java' title='BlockyCore.jar' content=blockycore %}

<br />
Review the code and note the sqlPass variable.

{% capture viewpassword %}
...
{% endcapture %}
{% include terminal.html language='java' title='BlockyCore.jar' content=viewpassword %}
...
[+] Notch
 ...
 <snip>
{% endcapture %}
{% include terminal.html language='bash' title='bash' content=enumusers %}
...
notch@Blocky:~$
{% endcapture %}
{% include terminal.html language='bash' title='bash' content=sshnotch %}
